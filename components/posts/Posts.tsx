...
const ProductCard = ({ product }: { product: typeof posts.$inferSelect }) => {
  return (<div className="rounded-lg overflow-hidden shadow-xl hover:shadow-2xl bg-white flex flex-col transform transition-all duration-300 ease-in-out hover:scale-105 cursor-pointer">
    {/* Product Image */}
